...
import static com.example.bonnie.mynewnotebook.MainActivity.dbOperator;
import static com.example.bonnie.mynewnotebook.R.layout.words_add;
...
public class InteractiveInterface extends Activity{
    ...
    //笔记本数据更新操作
    public void inflateEditDialog(final String old_eng,final String old_fre, final String old_domain){
        //substantialize the widgets
        ...
        alert_builder.setView(add_view).setNegativeButton("cancel", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                dbOperator.editWords(eng, fre, domain,old_eng); //单词在数据库中修改
